...
- Нажмите кнопку "Start Proxy"
- По умолчанию: `127.0.0.1:8888`

**Шаг 2:** Настройте браузер
- Firefox: Настройки → Сеть → Ручная настройка прокси
- Установите HTTP прокси: `127.0.0.1` порт `8888`
- Включите "Использовать этот прокси для HTTPS"

**Шаг 3:** Установите CA сертификат (для HTTPS)
- Перейдите на: http://burp (или http://127.0.0.1:8888)
- Скачайте `cacert.pem`
- Импортируйте в браузер или систему
...
- [GitHub](https://github.com/pentool/pentool) — исходный код, issues, discussions
