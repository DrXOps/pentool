...
from pentool.utils.intercepted_request import InterceptedRequest, InterceptState
...
InterceptedRequest = InterceptedRequest  # noqa: PLC0104
InterceptState = InterceptState  # noqa: PLC0104
    ...
    async def _send_request(self, req: ParsedRequest) -> ParsedResponse | None:
        try:
            ...
            if self._http_client is None:
                ...
                self._http_client = get_shared_http_client(follow_redirects=True, cfg=get_config())
